...
contract HelperConfig is Script {
    ...
    string public constant BASE_URI = "ipfs://bafybeifmubmzo44kp7txputm72okodpyihencmlzstgyweyqpi7rn7eyzu/";
     ...
     */
    string public constant NAME = "Flameling Queens";
    string public constant SYMBOL = "QUEEN";
    address public constant FEE_ADDRESS_MAIN = 0xd055eF33470f29F97e05e4B70321480b9C81465c;
    address public constant TOKEN_ADDRESS_MAIN = 0x45e26B10Ae6f95d9d5133720937693E17171F7F9;

    /**
     * TESTNET
     */
    address public constant FEE_ADDRESS_TEST = 0x7Bb8be3D9015682d7AC0Ea377dC0c92B0ba152eF;
    address public constant TOKEN_ADDRESS_TEST = 0x563F5a7fa101dD7051853604ec63103Ab6226c7b;

    /**
     * LOCAL
     */
    address public constant FEE_ADDRESS_LOCAL = 0x70997970C51812dc3A010C7d01b50e0d17dc79C8;
    ...
    constructor() {
        if (
             ...
             * bsc testnet
             */
            block.chainid == 11155111 || block.chainid == 97 || block.chainid == 84532
        ) {
            /**
             * base sepolia
             */
